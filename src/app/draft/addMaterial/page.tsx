      ...
      <div className="w-[390px]">
        ...
        <div className="h-[67x] pt-[20px] border-b-2">
          <div className="h-[23px] px-[19px]">
            <div className="font-bold w-[48px] mb-1 text-[16px]">材料名</div>
          </div>
        ...
        <div className="h-[167px] mt-8">
          ...
          <div className="h-[144px] py-3 px-4 border-x-2 border-y-2">
            <textarea
              ...
              placeholder="キャベツはなんでもOKですキャベツはなんでもOKですキャベツはなんでもOKですキャベツはなんでもOKですキャベツはなんでもOKですキャベツはなんでもOKですキャベツはなんでもOKですキャベツはなんでもOKです"
            />
          </div>
        </div>
      </div>
